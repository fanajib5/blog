...
The last four episodes opened the inherited _frontend_ building. Now that the door is shut again, here's what's inside:
...
With this episode, two Hijrah series stand complete: [one _backend_](/en/writing/2026/hijrah-backend-01/), one _frontend_, two sides of the same building, serving tens of thousands of users every day without ever once asking for applause.
...
[^1]: Inventory figures refer to earlier episodes in this series, each of which carries its own measurement notes.

[^2]: Library, framework, and stack details stay simplified, consistent with the whole series.
